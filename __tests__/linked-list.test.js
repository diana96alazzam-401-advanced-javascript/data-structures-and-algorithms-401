...
describe('Linked List', () => {
  ...
  it('2. Can properly insert at the end of the linked list', () => {
    const linkedListInstance = new linkedListModule();
    linkedListInstance.append(7); //head
  ...
  it('3. The head property will properly point to the first node in the linked list', () => {
    const linkedListInstance = new linkedListModule();
    linkedListInstance.append(6); //head
    linkedListInstance.append(5);
    expect(linkedListInstance.head.value).toStrictEqual(6);
  });
  it('4. Can properly insert multiple nodes at the end of the linked list', () => {
    const linkedListInstance = new linkedListModule();
    linkedListInstance.append(5);
